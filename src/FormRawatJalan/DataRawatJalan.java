...
private Connection conn = new Koneksi().connect();
    private void tampilkanData(){ 
        ...
        try{
            ...
            while(res.next()){
                String id_rawat_jalan =res.getString("id_rawat_jalan");
                tableModel.addRow(new Object[]{no++,res.getString(1),res.getString(2),res.getString(12),res.getString(19),res.getString(18), res.getString(20), res.getString(4), res.getString(5)});
            }
...
try {
            String path="./src/FormRawatJalan/ReportRawatJalan.jasper";
