...
private Connection conn = new Koneksi().connect();
    ...
    private void tampilkanData(){ 
        ...
        try{
            ...
            while(res.next()){
                tableModel.addRow(new Object[]{no++,res.getString(1),res.getString(2),res.getString(12),res.getString(18), res.getString(3), res.getString(4), res.getString(5)});    
            }
...
try {
            String path="./src/FormPembayaran/ReportPembayaran.jasper";
