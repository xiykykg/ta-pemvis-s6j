...
private Connection conn = new Koneksi().connect();
    ...
    private void btncariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncariActionPerformed
        ...
        try{
            ...
            if(res.next()){
                int id_spesialis = idSpesialis.indexOf(res.getString(17));
                ...
                int id_dokter = idDokter.indexOf(res.getString(12));
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
       if(txtidpasien.getText().equals("") || txtnamapasien.getText().equals("") || cbspesialis.getSelectedIndex() ==  0 || cbdokter.getSelectedIndex() ==  0 || tadiagnosa.getText().equals("") || dttanggal.getDate()==null ){
            ...
            try {
                ...
                String sql = "INSERT INTO pemeriksaan(kode_periksa, id_pasien, id_dokter, diagnosa, tgl_periksa) "
